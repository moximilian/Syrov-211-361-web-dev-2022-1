...
function autocompleteItemClick(event) {
...
window.onload = function () {
    ...
    // задание 1
    document.querySelector('.search-btn').onclick = searchString; 
    //задание 2
    document.querySelector('.search-field').oninput = autocompleteHandler;
    document.querySelector('.autocomplete').onclick = autocompleteItemClick;
}   